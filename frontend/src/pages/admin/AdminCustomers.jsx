...
export default function AdminCustomers() {
  ...
  if (isLoading) {
    return <div className="text-center py-32 text-gray-400 font-medium animate-pulse">Loading Customers...</div>;
  }
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-12">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">Registered Customers</h2>
          <p className="text-gray-500 mt-1">Manage and view all customers on the platform.</p>
        </div>
      </div>
